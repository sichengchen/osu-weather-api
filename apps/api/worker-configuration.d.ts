/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts --config ../../wrangler.jsonc` (hash: 5ab5710b616c555d1cc01d0d31e21ee4)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		HISTORY_CAPTURE_INTERVAL_SECONDS: "600";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HISTORY_CAPTURE_INTERVAL_SECONDS">> {}
}
